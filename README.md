...
Edit the parameters in `scripts/main.py` — specifically the `MasterFunction` constructor arguments (e.g. `alpha_values`, `noise_values`, `sample_type`, `simulations`, etc.). See the research paper for the specific parameter values used.
...
│        └─ FV_26_Thomas_Christian.xlsx # 2026 candidate VAA responses
│
